...
from aug_pad import ImgEvalTransform, ImgEvalReverseTransform
import torch
...
path_dir = "/home/leandro/Documentos/doutorado/tmp/shap/models/pad"
path_dir = "/home/leandro/Documentos/doutorado/tmp/shap/models/pad/dev_only"

new_ds_path = "/home/leandro/Documentos/doutorado/dados/pad-ufes-20"
new_img_path = "/home/leandro/Documentos/doutorado/dados/pad-ufes-20/images"
...
for item in p_list:
    ...
    try:
        ...
        _csv_path_train = Path(_base_path, Path(data['_csv_path_train']).name)
    ...
    try:
        ...
        _task_dict['col_sparse'] = ["smoke", "drink", "background_father", "background_mother", "pesticide", "gender",
                    "skin_cancer_history",
                    "cancer_history", "has_piped_water", "has_sewage_system", "fitspatrick", "region", "itch", "grew",
                    "hurt",
                    "changed", "bleed", "elevation"]
        _task_dict['col_dense'] = [
            "age",
            "diameter_1",
            "diameter_2",
        ]
    ...
    print(len(_meta_data_columns))

    _label_name = _task_dict["label"]
    _img_path_col = _task_dict['img_col']
    label_number_col = F"{_label_name}_number"
