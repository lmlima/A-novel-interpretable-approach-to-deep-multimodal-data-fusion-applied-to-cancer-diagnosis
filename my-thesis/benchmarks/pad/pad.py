# -*- coding: utf-8 -*-
"""
Autor: André Pacheco, Leandro Lima
...
def cnfg():
    ...
    _experimental_cfg = {
        ...
        "late_fusion": {
            ...
            "pretrained_outer_classifier": None,  # "mlp" or "transformer". Use None if no late/mixed fusion
...
def main(_folder, _csv_path_train, _imgs_folder_train, _lr_init, _sched_factor, _sched_min_lr, _sched_patience,
    ...
    # optimizer = optim.AdamW(model.parameters(), lr=_lr_init, weight_decay=0.001)
